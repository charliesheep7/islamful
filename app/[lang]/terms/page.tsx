    ...
    <SectionContainer>
      <div className="prose dark:prose-invert max-w-none py-8" dir="rtl">
        ...
        <p>
          ...
          سرية معلومات تسجيل الدخول الخاصة بك. أخطرنا على الفور على vip@deenup.app إذا كنت تعتقد أن
          حسابك قد تم اختراقه.
        </p>
        ...
        <p>
          ...
          الإبلاغ عن المخاوف على vip@deenup.app.
        </p>
        ...
        <p>إذا كنت تعتقد أن المحتوى ينتهك حقوقك، اتصل بـ vip@deenup.app وسنراجع على الفور.</p>
