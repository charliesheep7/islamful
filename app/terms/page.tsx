  ...
  return (
    <SectionContainer>
      <div className="prose dark:prose-invert max-w-none py-8">
        ...
        <p>
          <strong>Last updated: [Month Day, Year]</strong>
        </p>
        <p>
        ...
        <ul>
          ...
          <li>
            Use the Services to spread misinformation presented as authoritative religious rulings
          </li>
        </ul>
        <p>
        ...
        <p>
          The Services may generate responses using artificial intelligence. AI content may be
          incorrect, incomplete, or outdated. It is provided for educational and spiritual support
          only.
        </p>
        <p>
          Nothing in the Services constitutes religious rulings (fatwa), counseling, legal, medical,
          or other professional advice. Always consult qualified scholars or professionals for
          serious matters.
        </p>
        <p>You use AI-generated responses at your own discretion and risk.</p>

        <h2>8. No Guarantee of Accuracy</h2>
        <p>
          Scripture, translations, and referenced content may come from third-party sources. We do
          not guarantee accuracy, reliability, availability, or completeness.
        </p>
