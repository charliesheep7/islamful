...
The **majority position is haram**. This is the position of Al-Azhar, the main Saudi fatwa bodies, and the European Council for Fatwa and Research. For a detailed fatwa on smoking and vaping, see [Dar al-Ifta al-Misriyyah](https://www.dar-alifta.org/en) and [IslamQA](https://islamqa.info/en/answers/10922).
