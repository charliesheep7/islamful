...
**Fictional magic and supernatural powers.** Many popular anime series feature characters with supernatural abilities. Scholars distinguish between **fantasy storytelling** (fictional powers like flying or super-strength) and **actual depictions of sihr** (sorcery, summoning jinn, occult rituals). The former is generally tolerated in fiction; the latter should be avoided, as Islam strictly prohibits [magic and sorcery](/blog). The same content-based analysis applies to questions like [is singing haram](/blog/is-singing-haram) — the activity itself is not forbidden, but the content matters.
