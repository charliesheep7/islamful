...
When the qualified scholars of an era agree on a ruling, that consensus carries authoritative weight. Ijma on major issues — like the prohibition of pork, [alcohol](/blog/is-alcohol-haram), and interest — is as strong as an explicit textual ruling.
...
Modern life has introduced categories of questions that classical scholars never directly addressed. How do Islamic principles apply today?

**Social media and content consumption** — Watching or creating content that involves music, mixed-gender interaction, or immodest imagery raises concerns. The framework is unchanged: does it lead to haram, harm the mind or character, or crowd out religious obligations? Content that does none of these things falls in a gray area; content that clearly does falls toward makruh or haram.

**Cryptocurrency and digital finance** — Scholars are actively debating this. Most agree that trading speculative cryptocurrencies without underlying productive activity resembles maysir (gambling). Others permit it as a form of currency exchange. Follow a recognized scholar you trust on this — it is a genuinely open question.

**AI-generated content and digital images** — Scholars have begun addressing whether AI-generated images of people are subject to the same rulings as drawn or photographed images. The majority position in early scholarly discussions is that prohibited imagery (immodest, idolatrous) remains prohibited regardless of the medium used to create it.

**Subscription services** — Paying a flat fee for access to a service (streaming, software) is a standard commercial transaction — halal. What matters is the nature of the content consumed, not the subscription model itself.

The underlying methodology has not changed. The questions are new; the tools to answer them — Quran, Sunnah, ijma, qiyas — are the same ones scholars have used for fourteen centuries.
